function [particle_identifier] = actin_polarity_construct_particle_identifier(k,i,zaehler)
%%%%%%%%%%%%
%%%%%%%%%%%%
...
particle_identifier = ['t_' tzeros num2str(k) '_p_' pzeros num2str(i) '_n_' nzeros num2str(zaehler)];
