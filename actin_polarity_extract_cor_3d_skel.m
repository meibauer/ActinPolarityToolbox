function [actin_3d_cor_all,filament_list] = actin_polarity_extract_cor_3d_skel(actin_seg,distance_to_next_point)
%%%%%%%%%%%
%%%%%%%%%%%
% This program extracts coordinates along a actin filament from an already skeletonized and cleaned segmentation.
%
% INPUT
% actin_seg                       --- skeletonized and cleaned segmentation
